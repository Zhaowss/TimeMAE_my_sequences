...
import os
import json
from datautils import load_UCR, load_HAR, load_mat,load_mydata
...
parser.add_argument('--num_epoch_pretrain', type=int, default=10)
...
if args.data_path is None:
    if args.dataset == 'ucr':
        ...
        Train_data_all, Train_data, Test_data =load_mydata()
        args.num_class = len(set(Train_data[1]))
else:
    if args.dataset == 'ucr':
        path = args.data_path
        ...
        path = args.data_path
        Train_data_all, Train_data, Test_data =load_mydata(path)
        args.num_class = len(set(Train_data[1]))
